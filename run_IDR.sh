...
IDR_THRESH=0.05
REP1_VS_REP2="${PREFIX}_REP1vREP2"
IDR_OUTPUT="${REP1_VS_REP2}_overlapped-peaks.txt"

idr --samples ${REP1_PEAK_FILE} ${REP2_PEAK_FILE} --peak-list ${POOLED_PEAK_FILE} --input-file-type narrowPeak --output-file ${IDR_OUTPUT} --rank p.value --plot --use-best-multisummit-IDR
